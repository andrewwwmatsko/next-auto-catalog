const accordionData = [
  ...
  {
    title:
      "Is it possible to connect a calculator to the site so that people can do the math themselves auto?",
    text: "Updates every hour. That is why you are always on the site lots will be relevant.",
  },
  {
  ...
  {
    title:
      "If I take the Base tariff, will the catalog be visually different from my site?",
    text: "Updates every hour. That is why you are always on the site lots will be relevant.",
  },
];
